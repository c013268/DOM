...
fct_mao_ord_line as (
    select oh.doc_type_id,oh.ccy_cd,oh.ord_locale,oh.cust_id,oh.flx_id,oh.pymt_status_id,oh.ord_total,oh.confirmed_ts,oh.captured_ts,oh.created_ts,ol.* except(created_ts),
    ...
    from ${dom_gold_db}.${dom_gold_schema}.fct_mao_ord_line_hist_v ol
		...
		left join fct_mao_ord_line_fv fv on (ol.org_id = fv.org_id and ol.ord_id = fv.ord_id and ol.ord_ln_id = fv.ord_ln_id and fv.fv_rnk = 1)
...
mao_consignments as (
	select 'DCFulfillment' as fulflmnt_type,fd.org_id,fd.fulflmnt_dtl_pk,fd.fulflmnt_dtl_id,fd.ord_id,fd.ord_ln_id,fd.rel_id as fulflmnt_id,fd.rel_ln_id as fulflmnt_ln_id,
		...
		fd.gift_card_pin,fd.gift_card_value,fd.carrier_cd,fd.tracking_num,fd.serial_num,fd.sgtin,fd.channel,
		...
		ol.ship_to_addr_first_name,ol.ship_to_addr_last_name,ol.ship_to_addr_email,ol.ship_to_addr_phone,ol.ship_to_addr_addr1,
		ol.ship_to_addr_addr2,ol.ship_to_addr_city,ol.ship_to_addr_country,ol.ship_to_addr_state,ol.ship_to_addr_postal_cd,
		ol.cust_id,ol.flx_id,ol.ord_total,ol.cart_shpmnt_method,ol.shpmnt_method,ol.ord_locale,ol.itm_size,
		fd.fulflmnt_dtl_id as entryId, ol.pymt_status_id,ol.total_charges,ol.cnlled_total_charges,ol.ord_sales_tax_amt,ol.cnlled_ord_sales_tax_amt,
		fd.is_rejected,null as short_reason_id, null rejected_flg,coalesce(fd.rel_created_ts,fd.created_ts) as rel_created_ts,
		ol.fv_orig_unit_price,ol.fv_unit_price,ol.fv_cnlled_total_disc,ol.fv_total_disc,ol.fv_cnlled_ord_ln_total,ol.fv_ord_ln_total,
		ol.fv_cnlled_total_charges,ol.fv_total_charges,ol.fv_cnlled_total_taxes,ol.fv_total_taxes,
		ol.fv_cnlled_ord_shipping_amt,ol.fv_ord_shipping_amt,
		ol.fv_cnlled_ord_shipping_tax_amt,ol.fv_ord_shipping_tax_amt,
	...
	select 'StoreFulfillment' as fulflmnt_type,fd.org_id,fd.fulflmnt_dtl_pk,fd.fulflmnt_dtl_id,fd.ord_id,fd.ord_ln_id,fd.rel_id as fulflmnt_id,fd.rel_ln_id as fulflmnt_ln_id,
		...
		fl.cnlled_total_disc,fl.cnlled_ord_ln_total,fl.cnlled_ord_shipping_amt,fl.cnlled_ord_shipping_tax_amt,fl.cnlled_ord_ln_sub_total,fl.cnlled_total_taxes,
		...
		fl.ship_to_addr_first_name,fl.ship_to_addr_last_name,fl.ship_to_addr_email,fl.ship_to_addr_phone,fl.ship_to_addr_addr1,
		fl.ship_to_addr_addr2,fl.ship_to_addr_city,fl.ship_to_addr_country,fl.ship_to_addr_state,fl.ship_to_addr_postal_cd,
		fl.cust_id,fl.flx_id,fl.ord_total,fl.cart_shpmnt_method,fl.shpmnt_method,fl.ord_locale,fl.itm_size,
		fd.fulflmnt_dtl_id as entryId, fl.pymt_status_id,fl.total_charges,fl.cnlled_total_charges,fl.ord_sales_tax_amt,fl.cnlled_ord_sales_tax_amt,
		fd.is_rejected,fl.short_reason_id,fl.rejected_flg,fl.created_ts as rel_created_ts,
		fl.fv_orig_unit_price,fl.fv_unit_price,fl.fv_cnlled_total_disc,fl.fv_total_disc,fl.fv_cnlled_ord_ln_total,fl.fv_ord_ln_total,
		fl.fv_cnlled_total_charges,fl.fv_total_charges,fl.fv_cnlled_total_taxes,fl.fv_total_taxes,
		fl.fv_cnlled_ord_shipping_amt,fl.fv_ord_shipping_amt,
		fl.fv_cnlled_ord_shipping_tax_amt,fl.fv_ord_shipping_tax_amt,
		fl.fv_cnlled_ord_ln_sub_total,fl.fv_ord_ln_sub_total,
		fl.fv_cnlled_ord_sales_tax_amt,fl.fv_ord_sales_tax_amt
	from
  		mao_ord_fulfillment_detail fd
...
consignments as (
  ...
  select c.*,
    ...
    END AS entryStatus
  from mao_consignments c
    left join pymt_txn_status pymt_txn on (c.org_id = pymt_txn.org_id and c.ord_id = pymt_txn.ord_id)
  where c.pymt_status_id = 5000
    and ((c.fulflmnt_type = 'DCFulfillment' AND c.fulflmnt_ln_status_id BETWEEN 1000 AND 2000) OR (c.fulflmnt_type = 'StoreFulfillment' AND c.fulflmnt_ln_status_id = 1000 ))
),
...
select
  ...
  from
    ...
    join consignment_entries ent on (con.org_id=ent.org_id and con.ord_id=ent.ord_id and con.consignment_id=ent.consignment_id and con.consignment_status=ent.consignment_status)
	  left join payment_grouped pymt_line on (con.org_id = pymt_line.org_id and con.ord_id = pymt_line.ord_id)
