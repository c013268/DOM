...
{% set target_context_typ2_column_list = 
	...
	"csa_ord_note","credits_info","liability_amt","cnlled_ord_promo_amt","cnlled_ord_coupon_amt","cnlled_ord_shipping_amt","cnlled_ord_shipping_tax_amt",
	"cnlled_ord_sales_tax_amt","cnlled_orig_ord_shipping_amt","cnlled_orig_ord_shipping_tax_amt","cnlled_orig_ord_sales_tax_amt",
	"cnlled_ord_sub_total","cnlled_ord_total","cnlled_ord_total_charges","cnlled_total_discs","cnlled_ord_total_taxes","ord_promo_amt","ord_coupon_amt",
	"ord_shipping_amt","ord_shipping_tax_amt","ord_sales_tax_amt","orig_ord_shipping_amt","orig_ord_shipping_tax_amt","orig_ord_sales_tax_amt",
	"confirmed_ord_total","ord_sub_total","ord_total","ord_total_charges","ord_total_discs","ord_total_taxes","rfnd_req_total_amt","rfnd_req_total_cc_amt",
	"rfnd_req_total_paypal_amt","rfnd_act_total_amt","rfnd_act_total_cc_amt","rfnd_act_total_paypal_amt","rtn_act_total_amt","rtn_req_total_credits",
...
{{ config(
    ...
    post_hook=["{{ fl_utils.m_upd_typ2_activ_records_dom( this ,'hash_sk' ,'hash_seq_num' ) }}",
					"{{ fl_utils.m_apply_typ2_deletion_on_tgt_model( ref('mao_ord_order_history_t'), this, 'ord_pk' ) }}",
...
with
    mao_ord_order_history as (
        select
            ...
            oh.min_fulfillment_status_id::decimal(38, 0) as min_fulfillment_status_id,
            case when oh.max_fulfillment_status_id != '' then oh.max_fulfillment_status_id::decimal(38, 0) end as max_fulfillment_status_id,
            oh.cancel_reason_id,
            oh.currency_code,
            oh.customer_type_id,
            oh.order_type_id,
        ...
        from {{ ref('mao_ord_order_history_t') }} oh
        {% if is_incremental() %}
            where
    ...
    ord_hdr_stg as (
        select
            ...
            ,oh.min_fulfillment_status_id as min_fulflmnt_status_id
            ,st2.description as min_fulflmnt_status_desc
            ,oh.max_fulfillment_status_id as max_fulflmnt_status_id
        ...
        from mao_ord_order_history oh
            ...
            left join status_definition_stg st2 on oh.min_fulfillment_status_id = st2.status and st2.process_type_id = 'order_execution'
            left join status_definition_stg st3 on oh.max_fulfillment_status_id = st3.status and st3.process_type_id = 'order_execution'
